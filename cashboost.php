...
<html lang="De"><head>
        ...
        <meta name="verification" content="5beb210f277740818ab1e9c19d5e8a6a" />
                ...
                <title>CashBoost</title>
        <meta name="keywords" content="welcome meta keywords" />
        <meta name="description" content="welcome meta description" />
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta property="og:title" content=""/>
        <meta property="og:description" content=""/>
        <meta property="og:image" content=""/>
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <link rel="alternate" hreflang="De" href="https://www.cashbackdeals.de/user/cashboost.php" />

        
        <link rel="canonical" href="https://www.cashbackdeals.de/user/cashboost.php"/>
        ...
        <link rel="stylesheet" href="/general.assets/css/lightbox.css" type="text/css" />
        <script src="/general.assets/js/lightbox.js" type="text/javascript"></script>
    ...
    <div id="breadcrumbs"> <ol itemscope itemtype="http://schema.org/BreadcrumbList"> 
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    ...
                    </li><li>CashBoost</li></ol> </div>
      
        <h2 class="new-heading">Freunde einladen</h2>
    <div id="refer-friends-header">
        <div><img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/invite-friends-header.gif" alt="invite-friends-header" width="960" height="186" /></div>
        <div id="refer-friends-header-text">Lade deine Freunde ein und verdiene <strong> 5,00 CashCoins + 10% </strong> <br>aller Umsätze deiner Freunde!</div>
    </div>


    <!-- <p><img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/friendsmodule-2.jpg" class="ResponsImg" width="720" height="230" alt="banner" style="margin-top:10px" /></p> -->
    <div class="friendmodule-intro">
        <p>Stell deiner Familie und deinen Freunden die beste Seite zum Geld verdienen vor! Für jeden eingeladenen Freund bekommst du 5,00 CashCoins, sobald dieser zusätzlich 10,00 CashCoins angesammelt hat (ohne Anmeldebonus). Zusätzlich erhältst du 10% aller Umsätze jedes eingeladenen Freundes. Nicht nur einmal, sondern für immer! </p> <p>Zum Beispiel: Wenn dein Freund sich bei CashbackDeals.de registriert, bekommst du 5,00 CashCoins, sobald dein Freund zusätzlich 10,00 CashCoins angesammelt hat (ohne Anmeldebonus). Wenn dein Freund dann über uns online einkauft und sich 20,00 CashCoins verdient, erhältst du außerdem 2,00 CashCoins (10% von 20,00 CashCoins) als zusätzlichen Bonus auf dein Konto.</p> <p>Je mehr Freunde du einlädst, desto höher werden deine Einnahmen! Du kannst so viele Freunde einladen, wie du möchtest. Bitte beachte dabei keinen Spam zu versenden.</p> <p><b>Achtung!</b> Die Verwendung von Mehrfach-Accounts ist untersagt und wird bestraft.<br> <h1>Teile CashbackDeals.de</h1><br> Du kannst Freunde über 3 Arten auf CashbackDeals.de hinweisen:</p>
    </div>
    <!-- Start Expert Content -->
    <div class="referways one"> <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/expert-1.png" alt="1" />
        <h3>EINLADUNG VERSENDEN</h3>
        <span>
            <p>über E-Mail, Twitter und Facebook</p>
            <a class="tellfriend" href="#inline_tellafriends" onClick="loadPopup('.tellfriend', '800', '550', 'tellafriends');
            showTellafriendForm();"> <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-mail.png" width="44" height="44" class="referways-icons first" /></a> <a href="#" onClick="javascript: NewWinScrolls('http://twitter.com/share?url=https://www.cashbackdeals.de/u/481925&text=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.', 'Share on Twitter', 600, 450); return false;"><img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-twitter.png" width="44" height="44" class="referways-icons" /></a> <a href="#" onClick="javascript: NewWinScrolls('https://www.facebook.com/dialog/feed?app_id=354800814617179&link=https://www.cashbackdeals.de/u/481925&name=' + encodeURIComponent('CashbackDeals.de') + '&picture=https://www.ipay.nl/templates/default/assets/logo-icon.png&description=Verdiene extra Geld und bekomme direkt 7,50 CashCoins.&redirect_uri=https://www.cashbackdeals.de/', 'Share on Facebook', 600, 450); return false;"><img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/refer-facebook.png" width="43" height="44" class="referways-icons" /></a>
            
        </span> </div>
    <div class="referways two"> <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/expert-2.png" alt="2" />
        <h3>Persönlicher LINK</h3>
        <span> Teile deinen persönlichen Link in Foren oder auf deiner Website:
            <input type="text" value="https://www.cashbackdeals.de/u/481925" style="width:192px; border:1px solid #ccc;" />
            <span><a href="#" id="open-link" class="showbanners">Link erstellen</a></span> </span></div>
    <div class="referways three"> <img src="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/assets/expert-3.png" alt="3" />
        <h3>Banner</h3>
        <span>
            <p>Binde einen unserer CashbackDeals.de-Banner auf deiner Website ein</p>
            <a href="#" id="open-banner" class="showbanners">BANNER ANZEIGEN</a> </span> </div>
    <div id="showLinks">
        <div class="search_web-shop">

            <span class="search_shop_label">Suche Webshop: </span>
            <span class="search_shop_label"><input type="text" name="t" id="t" checked="store-field" onkeyup="getStoreResults(this.value)" value="" style="width: 95%;" />          
                <!-- searchBox for store results -->          
                <div style="background: none repeat scroll 0 0 #FFFFFF;display:none;position:relative;width:298px;z-index:222;" id="storeResults"></div>          
                <!-- end of searchBox for store results --></span>
        </div>
        <div class="search_web_shop">
            <span class="search_shop_label">Dein Code: </span>
            <span class="search_shop_input"><input type="text" name="store-link" id="store-link" value="" style="width: 95%;" readonly="readonly" onclick="ClipBoard()" /></span>
        </div>
    </div>
    <div id="showBanner">
        <div id="banners_cotainer" class="table_referer">
            <div class="place_banner-heading">
                <span class="banner_size"><strong>Größe</strong></span>
                <span class="banner_type"><strong>HTML</strong></span>
                <span class="banner_preview"><strong>Vorschau</strong></span>
            </div>
                                        <div class="place_banner-details">
                    <span class="banner_size">500 x 500</span>
                    <span class="banner_type"><a href="#getCode" id="pop0" onclick="fillPopup('500 x 500', 'https://static.orangebuddies.nl/image/banners/65_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '500', '500');loadPopup('#pop0', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="500 x 500" href="https://static.orangebuddies.nl/image/banners/65_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/65_ref.gif" alt="" /></a></span>
                </div>   
                                            <div class="place_banner-details">
                    <span class="banner_size">480 x 60</span>
                    <span class="banner_type"><a href="#getCode" id="pop1" onclick="fillPopup('480 x 60', 'https://static.orangebuddies.nl/image/banners/64_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '480', '60');loadPopup('#pop1', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="480 x 60" href="https://static.orangebuddies.nl/image/banners/64_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/64_ref.gif" alt="" /></a></span>
                </div>   
                                            <div class="place_banner-details">
                    <span class="banner_size">330 x 250</span>
                    <span class="banner_type"><a href="#getCode" id="pop2" onclick="fillPopup('330 x 250', 'https://static.orangebuddies.nl/image/banners/63_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '330', '250');loadPopup('#pop2', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="330 x 250" href="https://static.orangebuddies.nl/image/banners/63_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/63_ref.gif" alt="" /></a></span>
                </div>   
                                            <div class="place_banner-details">
                    <span class="banner_size">160 x 600</span>
                    <span class="banner_type"><a href="#getCode" id="pop3" onclick="fillPopup('160 x 600', 'https://static.orangebuddies.nl/image/banners/62_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '160', '600');loadPopup('#pop3', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="160 x 600" href="https://static.orangebuddies.nl/image/banners/62_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/62_ref.gif" alt="" /></a></span>
                </div>   
                                            <div class="place_banner-details">
                    <span class="banner_size">125 x 125</span>
                    <span class="banner_type"><a href="#getCode" id="pop4" onclick="fillPopup('125 x 125', 'https://static.orangebuddies.nl/image/banners/61_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '125', '125');loadPopup('#pop4', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="125 x 125" href="https://static.orangebuddies.nl/image/banners/61_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/61_ref.gif" alt="" /></a></span>
                </div>   
                                            <div class="place_banner-details">
                    <span class="banner_size">120 x 60</span>
                    <span class="banner_type"><a href="#getCode" id="pop5" onclick="fillPopup('120 x 60', 'https://static.orangebuddies.nl/image/banners/60_ref.gif', 'https://www.cashbackdeals.de/u/481925', 'CashbackDeals.de', 'Link-Code für CashbackDeals.de-Banner', '120', '60');loadPopup('#pop5', '910', '650')">Code anzeigen</a></span>
                    <span class="banner_preview"><a rel="lightbox[refimages]" title="120 x 60" href="https://static.orangebuddies.nl/image/banners/60_ref.gif"><img src="https://static.orangebuddies.nl/image/banners/60_ref.gif" alt="" /></a></span>
                </div>   
                                    </div>
    </div>
    <div class="clearfix">&nbsp;</div>
    <div id="friendmodule-invited">  
        <h2 class="new-heading">Übersicht geworbene Freunde</h2> 
        <!--table copied from old page https://www.cashbackkorting.nl/user/cashboost.php-->
        <div class="contentbox reffered-friends">
            <div class="nieuwsartikelen">
                <div class="account_heading_cashback">
                    <span>Freund</span>
                    <span style="width: 90px;">Saldo</span>
                    <span style="width: 100px;">Mitglied seit</span>
                    <span style="width: 175px;">Freunde-Bonus</span>
                    <span style="width: 66px;">Status</span>
                </div>	
                                                                <br> 
                                                <br>		
                                            </div>
                                        ...
                                        <!-- end table -->
                                        <div class="pages" id="Pagination"> <div ></div> </div> 
                                    </div>
                                    <!-- popup to be loaded on get code button -->
                                    <div class="bg" id="getCode" style="display: none;"> </div>
                                    <!-- end of popup code -->
                                </div>
                                <!-- End Main -->
    <div class="footerbanner 
         "> &nbsp;
                ...
                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '1,50%', storeName: 'Lieferando.de', urlKey: 'lieferando-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/87428.jpg', itemId: '0', bannerId: '34306', isCbkDay: '0'})"> 
                      
                        <img src="https://static.orangebuddies.nl/image/banners/34306-Normal.jpg" alt="Lieferando.de">
                                    </a> 
            ...
            $(document).ready(function ($) {
                ...
                $('form').each(function (index, value) { 
                    if(value.name != 'sort-shopsForm' && value.name != 'itune-form'  && value.name != 'cadeous-cards' ) {
                        token = '0ba8a5adabf7d82ee80d06ffa3c902510749e4bb';
                        $(this).append('<input type="hidden" name="csrf_token" value="' + token + '"><input type="hidden" name="csrf_page" value="cashboost">');
                    }
                });
                        ...
                        <div class="content">
                            <section id="section-1">
                                ...
                                <form action="https://www.cashbackdeals.de/user/register.php" method="post" enctype="application/x-www-form-urlencoded" name="form1" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlReg" class="ReturnUrl" value="/user/cashboost.php" />
                                </form>
                            ...
                            <section id="section-2">
                                ...
                                <form action="https://www.cashbackdeals.de/user/login.php" method="post" enctype="application/x-www-form-urlencoded" name="form2" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlLoginPopup" class="ReturnUrl" value="/user/cashboost.php" />
                                </form>
