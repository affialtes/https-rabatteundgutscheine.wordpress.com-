...
<html lang="De"><head>
        ...
        <link rel="alternate" hreflang="De" href="https://www.cashbackdeals.de/shops/all-categories.php" />

        
        <link rel="canonical" href="https://www.cashbackdeals.de/shops/all-categories.php"/>
        ...
        <link href="/general.assets/css/icon-fonts/font.css" rel="stylesheet" type="text/css" />
                <link href="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/css/myfonts/myfonts.css" rel="stylesheet"/>
                            ...
                            <div>
                                <div class="column">
                                    <ul>
                                        ...
                                        <li><a href="/user/cashmail.php"><i class="fa fa-envelope"></i> Posteingang (72)</a></li>
            ...
            <div id="container" class="clearfix">
                ...
                <div id="main">
                    <div id="main-content">
                            ...
                            <link href="https://static.orangebuddies.nl/templates/www.cashbackdeals.de/march16/css/categories-icons.css" rel="stylesheet" type="text/css" />
       ...
       <ol itemscope itemtype="http://schema.org/BreadcrumbList"> 
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                      ...
                      <meta itemprop="position" content="1" />
                        ...
                        <a itemprop="item" href="https://www.cashbackdeals.de/shops/all-categories.php">
                        <span itemprop="name">Alle Kategorien</span></a> 
                        <meta itemprop="position" content="2" />
                    </li></ol>
    </div>
    
 
<h2 class="new-heading">Alle Kategorien</h2>
<!--<style type="text/css">
.all_cat_container {
    float: left;
    width: 100%;
...
@media (max-width:568px){
  ...
  <div class="all_cat_container">
                             <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Baby & Kind <i class="icon-child"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/baby-walz.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/83216.jpg" alt="Baby-walz" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/baby-walz.php">
                              
                                                                                            <strong>bis zu 3,00 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/baby-markt-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7863.jpg" alt="babymarkt" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/baby-markt-de.php">
                                                                                            ...
                                                                                            <strong>bis zu 4,00 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/mytoys-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7833.jpg" alt="myToys.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/mytoys-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/babyshop-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6827.gif" alt="babyshop.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/babyshop-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/toys-r-us.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/toys-r-us.gif" alt="Toys R Us" class="banner" />
                                      </a>
                 ...
                 <a href="/shops/category-overview.php?url_key=baby-und-kind">Mehr zu Baby & Kind</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Bild & Ton <i class="icon-television"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/jbl-com.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/58362.jpg" alt="JBL.com" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/jbl-com.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/saturn-handytarife-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/61894.jpg" alt="SATURN Handytarife" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/saturn-handytarife-de.php">
                                                                                                                         <strong>bis zu 37,50 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/magix.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6212.jpg" alt="MAGIX" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/magix.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/rebuy-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/25033.gif" alt="reBuy.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/rebuy-de.php">
                                                                                            ...
                                                                                            <strong>bis zu 6,50 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/bang-und-olufsen-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/89229.jpg" alt="Bang & Olufsen" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=bild-und-ton">Mehr zu Bild & Ton</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Bücher & Zeitschriften <i class="icon-book-open-2"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/audible-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/audible-de.gif" alt="Audible.de" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/audible-de.php">
                                                                                                                         <strong>bis zu 10,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/thalia-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7255.jpg" alt="Thalia.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/thalia-de.php">
                                                                                            ...
                                                                                            <strong>bis zu 7,50 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/amazon.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8229.jpg" alt="Amazon" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/amazon.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/momoxde.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/22747.jpg" alt="momox.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/momoxde.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/weltbild-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/weltbild-de.jpg" alt="Weltbild.de" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=bucher-und-zeitschriften">Mehr zu Bücher & Zeitschriften</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Eintrittskarten & Tagestrips <i class="icon-direction-sign"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/dinner-krimi.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/27587.jpg" alt="DinnerKrimi" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/dinner-krimi.php">
                                                                                                                         <strong>5,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/mydays.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7271.jpg" alt="mydays" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/mydays.php">
                                                                                            ...
                                                                                            <strong>bis zu 5,50 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/ticketbis-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/72024.jpg" alt="Ticketbis" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/ticketbis-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/superticketladen-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/52493.jpg" alt="SuperTicketLaden" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/superticketladen-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/sea-life.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/9991.jpg" alt="SEA LIFE Berlin" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=eintrittskarten-und-tagestrips">Mehr zu Eintrittskarten & Tagestrips</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Elektronik & Unterhaltung <i class="icon-computer-imac-1"></i></h3>
                        </div>
                            ...
                            <a href="/cashback/amazon.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/asus.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/26564.jpg" alt="Asus" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/asus.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/bitdefender.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6367.jpg" alt="BitDefender" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/bitdefender.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/hp-store.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8146.jpg" alt="HP Store" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/hp-store.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/medionshop.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8278.jpg" alt="MEDIONshop" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=computer">Mehr zu Elektronik & Unterhaltung</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Essen & Trinken <i class=""></i></h3>
                        </div>
               
                                                    
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=essen-und-trinken">Mehr zu Essen & Trinken</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Finanzen & Strom <i class="icon-bank-2"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/ergodirekt-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/89355.jpg" alt="ERGO Direkt" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/ergodirekt-de.php">
                                                                                                                         <strong>bis zu 40,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/tarifcheck24-kfz.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/25503.jpg" alt="TARIFCHECK Kfz-Versicherung" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/tarifcheck24-kfz.php">
                                                                                                                         <strong>bis zu 25,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/gothaer-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/50638.jpg" alt="Gothaer" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/gothaer-de.php">
                                                                                                                         <strong>bis zu 15,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/web-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/51698.jpg" alt="WEB.DE" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/web-de.php">
                                                                                                                         <strong>bis zu 20,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/gothaer-unfallversicherung.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/55602.jpg" alt="Gothaer Unfallversicherung" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=finanzen">Mehr zu Finanzen & Strom</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Foto & Kamera <i class="icon-camera-2"></i></h3>
                        </div>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/saturn.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/10414.jpg" alt="SATURN" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/medionshop.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/fototassen-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/fototassen-de.gif" alt="fototassen.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/fototassen-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/shop4de-com.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/23738.gif" alt="shop4de.com" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/shop4de-com.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/lidl.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/56432.jpg" alt="Lidl" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/lidl.php">
                                                                                            ...
                                                                                            <strong>bis zu 35,00 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=foto-und-kamera">Mehr zu Foto & Kamera</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Games, Filme & Musik <i class="icon-cd"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/mediashop.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/30929.jpg" alt="MediaShop" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/mediashop.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/game-world.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/game-world.jpg" alt="Game World" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/rebuy-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/gearbest.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/31493.jpg" alt="GearBest" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/gearbest.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/maxdome.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8377.gif" alt="maxdome" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/maxdome.php">
                                                                                                                         <strong>bis zu 6,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=games-filme-und-musik">Mehr zu Games, Filme & Musik</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Geschäftliches <i class="icon-business-man-4"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/otto-office.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/9355.jpg" alt="OTTO Office" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/otto-office.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/ebuero-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/77200.jpg" alt="ebuero" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/ebuero-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/software-shopcom.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/22547.gif" alt="Software-Shop.com" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/software-shopcom.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/bueromoebel-experte.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/23449.jpg" alt="Büromöbel-Experte" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/bueromoebel-experte.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/burostuhl-onlineshop.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/23570.gif" alt="Bürostuhl Onlineshop" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/burostuhl-onlineshop.php">
                                                                                            ...
                                                                                            <strong>bis zu 2,50 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=geschaftliches">Mehr zu Geschäftliches</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Geschenke & Gadgets <i class="icon-present-box"></i></h3>
                        </div>
                            ...
                            <a href="/cashback/mydays.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/tui-magic-life-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/37904.jpg" alt="TUI MAGIC LIFE" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/tui-magic-life-de.php">
                                                                                                                         <strong>bis zu 32,50 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/valentins.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/9472.jpg" alt="Valentins" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/thalia-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/chocolissimo.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/22112.gif" alt="CHOCOLISSIMO" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=geschenke-und-gadgets">Mehr zu Geschenke & Gadgets</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Haushalt <i class="icon-plug-1"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/leonardo.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/leonardo.jpg" alt="LEONARDO" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/leonardo.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/quelle-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/10390.jpg" alt="QUELLE" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/quelle-de.php">
                                                                                            ...
                                                                                            <strong>bis zu 2,00 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/sugartrends.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/30640.jpg" alt="SugarTrends" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/sugartrends.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/naturehome-com.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/42919.jpg" alt="NATUREHOME" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/naturehome-com.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/hema.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/24421.gif" alt="HEMA" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=haushalt">Mehr zu Haushalt</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>iTunes <i class="fa fa-apple"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/httpswwwcashbackdealsdeproductsrabatte-bei-itunesphp.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/36304.jpg" alt="Erhalte 3,00% CashCoins auf alle iTunes Einkäufe" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=itunes">Mehr zu iTunes</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Mode & Fashion <i class="icon-polo-shirt"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/about-you.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/23015.jpg" alt="ABOUT YOU" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/about-you.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/asos-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/77259.jpg" alt="ASOS" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/asos-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/bader.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/85749.jpg" alt="Bader" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/bader.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/bonprixde.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/54519.gif" alt="bonprix" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/bonprixde.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/cecil.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8886.gif" alt="CECIL" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=mode">Mehr zu Mode & Fashion</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Sales <i class=""></i></h3>
                        </div>
               
                                                    
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=sales">Mehr zu Sales</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Schön & Gesund <i class="icon-heart-beat"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/the-body-shop.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/69306.jpg" alt="The Body Shop" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/the-body-shop.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/docmorris.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7332.jpg" alt="DocMorris" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/docmorris.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/lensbest.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/lensbest.jpg" alt="Lensbest" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/lensbest.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/switami.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6745.jpg" alt="Switamin" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/switami.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/hairlando.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/27217.gif" alt="Hairlando" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/hairlando.php">
                                                                                            ...
                                                                                            <strong>bis zu 5,00 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=schon-und-gesund">Mehr zu Schön & Gesund</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Spielzeug & Hobby <i class=""></i></h3>
                        </div>
                            ...
                            <a href="/cashback/mytoys-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/spiele-max-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/90901.gif" alt="SPIELE MAX" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/baby-walz.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/kuscheltier-schadstofffrei-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/91082.jpg" alt="babys-playtime" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=spielzeug-and-hobby">Mehr zu Spielzeug & Hobby</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Sport & Freizeit <i class="icon-sport"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/abe-motorradzubehoer.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/50094.jpg" alt="ABE-Motorradzubehör" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/abe-motorradzubehoer.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/raddiscount.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/22288.gif" alt="Raddiscount" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/raddiscount.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/swiminn.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6743.jpg" alt="SWIMINN" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/swiminn.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/planet-sports.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8542.jpg" alt="Planet Sports" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/planet-sports.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/reifendirekt-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/reifendirekt-de.jpg" alt="ReifenDirekt.de" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=sport-und-freizeit">Mehr zu Sport & Freizeit</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Tagesangebote <i class="icon-calendar-1"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/groupon-reisen.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/24445.jpg" alt="Groupon Reisen" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/groupon-reisen.php">
                                                                                            ...
                                                                                            <strong>bis zu 5,75 % CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/skyonline-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/43781.jpg" alt="Sky Online" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/skyonline-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/groupon-shopping.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7245.jpg" alt="Groupon Shopping" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/groupon-shopping.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/jeans-direct-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/24310.jpg" alt="Jeans-direct.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/jeans-direct-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/deal-banana-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/50836.jpg" alt="Deal Banana" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=tagesangebote">Mehr zu Tagesangebote</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Telefonie & Internet <i class="icon-phone-call-1"></i></h3>
                        </div>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/o2-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/90640.jpg" alt="O2" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/o2-de.php">
                                                                                                                         <strong>bis zu 90,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/smartmobil-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/91730.jpg" alt="smartmobil.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/smartmobil-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/vodafone-mobilfunk.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7701.jpg" alt="Vodafone (Mobilfunk & Data)" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/vodafone-mobilfunk.php">
                                                                                                                         <strong>bis zu 91,00 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/winsim-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/91320.jpg" alt="winSIM" class="banner" />
                                      </a>
                                   
                                </span>
                                <span class="cb-details">
                            <a href="/cashback/winsim-de.php">
                                                                                                                         <strong>bis zu 12,50 CashCoins</strong>
                                <i class="cat_arrow"></i>
                                </a></span>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=telefonie-und-internet">Mehr zu Telefonie & Internet</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Urlaub & Reisen <i class="icon-globe-1"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/skyscanner-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/84997.jpg" alt="Skyscanner" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/skyscanner-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/booking-com.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/6892.jpg" alt="Booking.com" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/booking-com.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/expedia-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/71042.jpg" alt="Expedia.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/expedia-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/eurosun-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/eurosun-de.gif" alt="eurosun.de" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/eurosun-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/ab-in-den-urlaub-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/90237.jpg" alt="ab-in-den-urlaub.de" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=urlaub-und-reisen">Mehr zu Urlaub & Reisen</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Warenhaus <i class="icon-store"></i></h3>
                        </div>
               
                                                      <div class="cat-row">
                                <span class="cb-logo">
                               
                                      <a href="/cashback/erwin-muller.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/79626.jpg" alt="Erwin Müller" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/erwin-muller.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/heine-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/88713.jpg" alt="Heine" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/heine-de.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/neckermann.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/24291.jpg" alt="Neckermann" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/neckermann.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/westfalia.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/westfalia.jpg" alt="Westfalia" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/westfalia.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/karstadt.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/karstadt.jpg" alt="KARSTADT" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=warenhaus">Mehr zu Warenhaus</a>
                    </div>
                      </div>
                            <div class="cat_stores_box">
                        <div class="cat-heading">
                                <h3>Wohnen & Garten <i class="icon-home-3"></i></h3>
                        </div>
                            ...
                            <a href="/cashback/bader.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/baur.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7336.jpg" alt="BAUR" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/baur.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/beleuchtungszentrum.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/beleuchtungszentrum.gif" alt="Beleuchtungszentrum" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/beleuchtungszentrum.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/disneystore.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/8334.jpg" alt="DisneyStore" class="banner" />
                                      </a>
                            ...
                            <a href="/cashback/disneystore.php">
                                ...
                                <span class="cb-logo">
                                      ...
                                      <a href="/cashback/fotoalbumfotobuch-de.php">
                                          <img src="https://static.orangebuddies.nl/image/stores/7073.jpg" alt="fotofabrik" class="banner" />
                                      </a>
                    ...
                    <div class="cat-footer">
                 <a href="/shops/category-overview.php?url_key=haus-und-garten">Mehr zu Wohnen & Garten</a>
                    </div>
                      </div>
  ...
  <!-- end lists -->
         ...
         "> &nbsp;
                ...
                <a class="various" href="#inline_store_visit" onclick="loginFancyPopUP({cashback: '37,50 ', storeName: 'blau Mobilfunk', urlKey: 'blau-mobilfunk-de', imgUrl: 'https://static.orangebuddies.nl/image/stores/90634.jpg', itemId: '0', bannerId: '34548', isCbkDay: '1'})"> 
                      
                        <img src="https://static.orangebuddies.nl/image/banners/34548-ExitPage468x60.jpg" alt="blau Mobilfunk">
                                    </a> 
            ...
            $(document).ready(function ($) {
                ...
                $('form').each(function (index, value) { 
                    if(value.name != 'sort-shopsForm' && value.name != 'itune-form'  && value.name != 'cadeous-cards' ) {
                        token = 'f7fed805ced8b5dc0c5317c94d00dfbdaa4b2448';
                        $(this).append('<input type="hidden" name="csrf_token" value="' + token + '"><input type="hidden" name="csrf_page" value="all-categories">');
                    }
                });
                        ...
                        <div class="content">
                            <section id="section-1">
                                ...
                                <form action="https://www.cashbackdeals.de/user/register.php" method="post" enctype="application/x-www-form-urlencoded" name="form1" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlReg" class="ReturnUrl" value="/shops/all-categories.php" />
                                </form>
                            ...
                            <section id="section-2">
                                ...
                                <form action="https://www.cashbackdeals.de/user/login.php" method="post" enctype="application/x-www-form-urlencoded" name="form2" target="_self"><!-- please remove ID or rename it -->
                                    ...
                                    <input name="ReturnUrl" type="hidden" id="ReturnUrlLoginPopup" class="ReturnUrl" value="/shops/all-categories.php" />
                                </form>
